        ...
        implements Loader
{
            ...
            throws IOException
    {
        ...
        int pixelStride = Integer.parseInt(ConfigFactory.Instance().getProperty("pixel.stride"));
        int rowGroupSize = Integer.parseInt(ConfigFactory.Instance().getProperty("row.group.size")) * 1024 * 1024;
        int blockSize = Integer.parseInt(ConfigFactory.Instance().getProperty("block.size")) * 1024 * 1024;
        short replication = Short.parseShort(ConfigFactory.Instance().getProperty("block.replication"));
